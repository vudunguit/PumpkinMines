...
public class GameGuide2 extends CCLayer {
...
//	CCScene scene = null;
	...
	public GameGuide2() {
		CCSprite bg = BackGround.setBackground(this, CGPoint.make(0.5f, 0.5f), 
				Utility.getInstance().getNameWithIsoCodeSuffix3(folder + "guide-tutorial2-i4-") + fileExtension);
